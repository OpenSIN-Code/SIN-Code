    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        for num_memories in [1000, 10000]:
            ...
            pop_time = run_benchmark(
                ...
                benchmark_remember, num_memories, db_path
            )
            if pop_time:
            ...
            recall_time = run_benchmark(
                ...
                benchmark_recall, num_memories, db_path
            )
            if recall_time:
            ...
            sqlite_time = run_benchmark(
                ...
                benchmark_sqlite_raw, num_memories, db_path
            )
            if sqlite_time:
            ...
            cons_time = run_benchmark(
                ...
                benchmark_consolidation, num_memories, db_path
            )
            if cons_time:
