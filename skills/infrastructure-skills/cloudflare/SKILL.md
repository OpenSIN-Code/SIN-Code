...
- The user asks about cloudflare infrastructure operations.
- A project needs to provision, query, or manage cloudflare resources.

## When NOT to Use

- The project does not use cloudflare.
- A native `sin-code cloudflare` command is available (future).
