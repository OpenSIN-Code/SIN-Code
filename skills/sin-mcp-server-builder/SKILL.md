...
Scaffold, extend, validate, publish, and audit MCP servers using the canonical OpenSIN-Code pattern: `pyproject.toml` + `src/<pkg>/mcp_server.py` + `tests/` + `*.doc.md` + `ceo-audit.yml`.
