...
class TestAuditHooks:
    ...
    def test_hooks_no_arbitrary_code_execution(self):
        ...
        assert "$(" not in _PRE_COMMAND_TEMPLATE or "basename" in _PRE_COMMAND_TEMPLATE or "mktemp" in _PRE_COMMAND_TEMPLATE
    ...
    def test_memory_isolation(self):
        ...
        try:
            ...
            try:
                ...
                mid1 = cortex1.remember("Project A secret", context={"project": "A"})
