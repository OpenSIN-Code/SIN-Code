...
// Code extracted from commands.go — Compile-spec section.

package main

// sin-debt: shrink, upgrade: when a second compile_spec-related command is added, merge into a shared file
