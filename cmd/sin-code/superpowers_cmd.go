...
// Code extracted from commands.go — Superpowers section.

package main

// sin-debt: shrink, upgrade: when a second superpowers-related command is added, merge into a shared file
