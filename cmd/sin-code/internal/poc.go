...
// specification by checking required symbols, forbidden patterns, and coverage.
// sin-debt: shrink, upgrade: when a second poc-related function is needed, merge into a shared file
package internal
