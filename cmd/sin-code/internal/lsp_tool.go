...
// Purpose: LSP (Language Server Protocol) command — IDE-grade code intelligence.
// Split from core_tools.go.
// sin-debt: shrink, upgrade: when a second lsp-related function is needed, merge into a shared file
package internal
