...
// Purpose: adw — Architectural Debt Watchdogs: detect god modules, circular
// deps, high coupling, long functions, large files, TODO/FIXME, missing tests.
// Split from analysis_tools.go to satisfy the shrink recommendation in issue #426.
// sin-debt: shrink, upgrade: when a second adw-related function is needed, merge into a shared file
package internal
