...
// reordered-but-equal calls do not escape the detector. Distinct
// args produce distinct fingerprints so the detector can tell
// "writing 'hello' to /tmp/a" apart from "writing 'goodbye' to
// /tmp/a".
