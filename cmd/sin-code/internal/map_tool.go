...
// Purpose: map command — code architecture mapping with dependency graphs,
// entry points, hot paths, and module-level analysis.
// Split from core_tools.go.
// sin-debt: shrink, upgrade: when a second map-related function is needed, merge into a shared file
package internal
