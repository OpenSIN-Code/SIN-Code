...
// Purpose: container scan subcommand for `sin-code security scan container`.
// Scans a container image or local path by running vendored scanners inside
// a container runtime (Apple container or Docker).
// Docs: security.doc.md
// sin-debt: shrink, upgrade: when a second container-related function is needed, merge into a shared file
package internal
