...
// Purpose: discover command — file discovery with relevance scoring,
// pattern matching, and dependency analysis.
// Split from core_tools.go.
// sin-debt: shrink, upgrade: when a second discover-related function is needed, merge into a shared file
package internal
