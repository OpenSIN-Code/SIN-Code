...
// Purpose: scout — parallel code search with optional ripgrep bridge.
// Split from analysis_tools.go to satisfy the shrink recommendation in issue #426.
// sin-debt: shrink, upgrade: when a second scout-related function is needed, merge into a shared file
package internal
