...
// Purpose: grasp — deep code understanding for a single file: structure,
// dependencies, usage, and related context. Also provides shared file-analysis
// helpers (detectLanguage, countLines, extractExports) used by other tools.
// Split from analysis_tools.go to satisfy the shrink recommendation in issue #426.
// sin-debt: shrink, upgrade: when a second grasp-related function is needed, merge into a shared file
package internal
