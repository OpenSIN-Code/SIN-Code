...
// Purpose: sckg — Semantic Codebase Knowledge Graphs: build & query code graph.
// Split from analysis_tools.go to satisfy the shrink recommendation in issue #426.
// sin-debt: shrink, upgrade: when a second sckg-related function is needed, merge into a shared file
package internal
