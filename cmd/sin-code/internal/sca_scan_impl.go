...
// Purpose: SCA scan subcommand for `sin-code security scan sca`.
// Runs the vendored SIN-Code-SCA-Tool-Go software composition analysis scanner,
// locates or builds the binary, and prints vulnerabilities in text/JSON format.
// Docs: security.doc.md
// sin-debt: shrink, upgrade: when a second sca-related function is needed, merge into a shared file
package internal
