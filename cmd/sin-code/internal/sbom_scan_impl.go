...
// Purpose: SBOM generation subcommand for `sin-code security scan sbom`.
// Generates a Software Bill of Materials using the vendored
// SIN-Code-SBOM-Generator-Go, auto-detecting the project manifest and
// emitting SPDX 2.3 or CycloneDX 1.5 JSON.
// Docs: security.doc.md
// sin-debt: shrink, upgrade: when a second sbom-related function is needed, merge into a shared file
package internal
