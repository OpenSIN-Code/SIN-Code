class SinCode < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.7/sin-code-darwin-arm64.tar.gz"
      sha256 "12dde8f8d92121511985509a1ef3c9058cd46155ea5e062b6aa3709b7765451a"
    else
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.7/sin-code-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.7/sin-code-linux-arm64.tar.gz"
      sha256 "73b0b93fc51e4350cde088aa38f79001343bc428b6dc80480161459c09f030a4"
    else
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.7/sin-code-linux-amd64.tar.gz"
