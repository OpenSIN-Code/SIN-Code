class SinCode < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.5-sin-code/sin-code-darwin-arm64.tar.gz"
      sha256 "c5c0ffeaddc66f25ed99547f20cde11fcc736184551e1d06b8e97fabf6ac4e91"
    else
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.5-sin-code/sin-code-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.5-sin-code/sin-code-linux-arm64.tar.gz"
      sha256 "e703370c48543744ea9bf293ceefa7e6603e30d0055f1366f57081787f84cb13"
    else
      url "https://github.com/OpenSIN-Code/SIN-Code/releases/download/v1.0.5-sin-code/sin-code-linux-amd64.tar.gz"
